...
2웃 q-> {웃_i, 웃_j}  selects two _different_ random people indexed i, j from the database 웃^ set

웃_1 + 웃_4 q-> {웃_1, 웃_4} selects exactly 웃_1 and 웃_4 from the database 웃^ set (TODO what if they are not inside?)
