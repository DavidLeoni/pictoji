...
Draw Unicode symbols:  https://shapecatcher.com/

Draw Latex symbols:  https://detexify.kirelabs.org/classify.html

Unicode long list: https://en.wikipedia.org/wiki/List_of_Unicode_characters

- (note it (obviously) doesn't list everything, sometimes there are additional links under the tables)

- Unicode search: https://unicode-explorer.com/


Symbols marked with ❗  as of Oct 2025 may have display problems on some platform:

- Apple /iOS: very often
- Windows: sometimes
...
လ:Myanmar ∽:? ∾:? ⏦ ∿ ᔓ:Canadian ᔔ:Canadian ᔕ:Canadian ᔖ:Canadian ᔥ:Canadian

ᔐ:Canadian ᔑ:Canadian ᔒ:Canadian 
...
🜺❗ 🜽❗🜶❗ 🜉❗ 🜛❗
🝆❗ (NOTE: alchemical is not well supported. Prefer very similar Tamil) 
⛬❗ (NOTE: ⛬❗ is alchemical, not the math symbol -> not safe :-/) 
...
ㄛ ㆖ ㆘ ㆜ 王 ꯊ ፑ ፖ Ⲳ:Coptic ⲳ:Coptic

⊣ Ю Ꮊ Ѥ ౫ 머 어 여 에 예 메 며  
...
Leavig them here for now, but probably too complex too be distinguishable

언 엉 듣 승  쓷 씅  씃  눙 능 웅 궁 쭈   윴 교 븡  

뉘  닝  돗 동 되 둗 둥 둫 듕 득  듬 듭 듯 듰 등 듲 듶 듵 딘 똔  똗 똠 똥 똣 
뚄 뚕 뚙 뚜 뚠 뚯 뚱 뜨 뜬 뜻 뜶 뜸 뜹 뜻 뜼 뜽 띂 띒 띰 띮 띵 롱 롳 루  
륻 름 릅 망 맛 맜 맥 맷 맸 맹 먕 먼 멍   명 묫 묬 묭 뭂 
묻 뭄 뭅 뮷 뮸 뮹 믄 믇 믌 믓 믔  믎 믕  믚 믙 밍 뱅 버 병 보 복 봉 봊 봋 
뵏 뵹 붇 붓 붔 붕 붖  뷲 뷴 븅 뽇 뽐 뽕 뾷 뿀 뿁 뿅 뿊  뿟 뿡 쁑  
쁜 쁟 쁟 쁨 쁩 쁫 쁬 쁭 숮 숳 슫 슲   
앉 애 앵 앶 앺  억 얶 옫 옷 옸 옹 옾 용 욷 운 움 웁 
욾 웄 웋 웋 웊 윳 윳  윽 은 읃 을 읏 읐   읒 읗   즁 증 쫃 쫑 쬬  쭝 쮸 
쯍 쯩 쿠 쿳 쿵 토 톧 툐 퉁 튜 튠 튯  튰 튱  튼 포 폳 폼 폿 퐀 퐁 
퐆 퐇 표 푯 푭 푬 푿 풋 풌 풍  퓽 퓻 퓸 퓸 퓹 퓽 픈 픆 픔 픕  혿 홆 홆 홉 홋 
홌 훙 훙 휴 휴 휸 휻 흄 흇 흉  
...
We need a graph chart lib that supports two usecases:
...
- target: casual user
- input: text statements in whatever syntax is best supported by target implementation 
- data: potentially a lot, at least whole English vocab, plus real world instances. 
- input: text statements in markedown, written in a concise way
- Take inspiration from Wikidata project
    - schema, ids
- markdown support: nice to have, not sure it's needed
- querying support: may be needed: 
    - adopt SPARQL?
    - alternative: like EdgeDB clean syntax?  
